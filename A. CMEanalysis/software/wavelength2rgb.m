...
if lambda >= 380 && lambda < 440
    rgbValue = [-(lambda-440)/60 0 1]; %orygianl rgbValue = [-(lambda-440)/60 0 1]
end
if lambda >= 440 && lambda < 490
    rgbValue = [0 (lambda-440)/50 1]; %orygianl rgbValue = [-(lambda-440)/60 0 1]
end
if lambda >= 490 && lambda < 510
    rgbValue = [0 1 -(lambda-510)/20]; %orygianl rgbValue = [-(lambda-440)/60 0 1]gfp
end
if lambda >= 510 && lambda < 580
    rgbValue = [(lambda-510)/70 1 0]; %orygianl rgbValue = [-(lambda-440)/60 0 1]
end
if lambda >= 580 && lambda < 645
    rgbValue = [1 -(lambda-645)/65 0]; %orygianl rgbValue = [-(lambda-440)/60 0 1] m ruby
end
if lambda >= 645 && lambda <= 780 
    rgbValue = [1 0 0]; %orygianl rgbValue = [-(lambda-440)/60 0 1] irfp
end
